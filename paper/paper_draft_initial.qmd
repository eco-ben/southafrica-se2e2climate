...
increase across modelled decades under GFDL-ESM4 (@sfig-net-primprod). Net primary
productivity is projected to decrease across decades under CNRM-CM6-1-HR, indicating a
divergence between ESMs.
...
outputs compared to guilds that diverge across ESMs. While the ecosystem is modelled to
transition to a increased predatory guild biomass and decreased low-trophic-level guild
biomass, ecosystem - scale mean trophic level is projected to show low levels of change as a
result of the high biomass of Omnivorous Zooplankton relative to other guilds in the
ecosystem.
