...
- Temperate marine ecosystems globally are facing increasing environmental change in ocean temperature, nutrient availability and stratification **fox-kemper**.
- Species survival and ecosystem functioning in marine ecosystems are vulnerable to increasingly variable environmental conditions **citation**, influencing the provision of ecosystem services such as fisheries **citation**.
- This investigation aims to assess the drivers of possible future ecosystem change in the Southern Benguela Upwelling System (SBUS).

- **Southern Benguela Upwelling System and climate change**
- The SBUS, South Africa, is a large eastern boundary current ecosystem that extends from the warm Aghulas current in the south to the northern Benguela system in the north.
- The SBUS is a highly productive wind-driven upwelling system, supporting large scale commercial and small-scale fisheries for South Africa **citations**.
- Productivity in this ecosystem exhibits high seasonal and decadal variability **citation** due to changes in environmental conditions such as temperature and upwelling, leading to highly variable fisheries production.

**Climate change impacts in SBUS**
- Ecosystem modelling using Atlantis by Ortega-Cisneros et al. **citation** found that the ecosystem is likely to face predatory fish declines due to temperature change, and planktivorous fish increases due to reductions in predation pressure.
- 
- This investigation uses a nutrient-driven ecosystem model, employing an exploratory scenario modelling approach to uncover possible future climate change impacts and causal drivers of change.

- **Marine ecosystem modelling, uncertainty and identifying causal relationships**
- Uncertainty plays a large role in projecting ecosystem models under climate change.
- Projection uncertainty is comprised of four facets: (1) structural uncertainty due to modelling methods; (2) initialisation and internal variability; (3) uncertainty associated with model parameterisation; and (4) scenario uncertainty due to modelling under highly uncertain future conditions **payne**.
